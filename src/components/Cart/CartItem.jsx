            ...
            <div className="container px-12 mt-2 py-1 mx-auto">
                <div className="flex items-center lg:w-3/5 mx-auto border-b border-r pb-4 mb-1 border-gray-200 lg:flex-row md:flex-row sm:flex-row justify-between">
                    ...
                    <div className="flex items-center  flex-end">
                        <button onClick={()=>eliminarItem(item.id)} className="inline-flex items-center border-0 py-1 px-3 mx-5 mt-10 focus:outline-none bg-gradient-to-r from-blue-300 to-blue-100 hover:from-blue-400 hover:to-blue-800 hover:text-white rounded-full text-base md:mt-0 text-lg font-bold" >Eliminar</button>
                    </div> 
                </div>
            </div>
        </section>
